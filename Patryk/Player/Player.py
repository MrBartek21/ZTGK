...
class Player_Move(object):
    def __init__(self,game):
        ...
        self.Game = game
        #Inicialization
        self.Player_pos = Vector2(10,(self.Game.ScreenHeight-200))
        self.gravity = 1
        self.sprint = 1
    ...
    def tick(self):
        ...
        if keys[pygame.K_RIGHT]:
            self.Player_pos.x += 5*self.sprint 
        #Jump
        if self.Player_pos.y<=self.Game.ScreenHeight-200:
            if keys[pygame.K_UP]:
                self.Player_pos.y -= 12
                self.gravity*=1.1
        ...
        if self.Player_pos.y<self.Game.ScreenHeight-200:        
            ...
            if self.Player_pos.y>self.Game.ScreenHeight-200:
               ...
               self.Player_pos.y = self.Game.ScreenHeight-200
               self.gravity=1
